    ...
    static updateInformations(){
        ...
        try {
            ...
            if (chosenOption < 12) {
                ...
                String[] candidateInformation = ['candidate_name', 'candidate_surname', 'candidate_birth', 'candidate_email', 'candidate_country', 'candidate_cep', 'candidate_state', 'candidate_description', 'candidate_age', 'candidate_cpf', 'candidate_password']
            ...
            if (chosenOption == 12){
                ...
                sql.execute("UPDATE candidate_skills SET id_skill = ${updatedSkill} WHERE id_skill = ${changeSKill} AND candidate_skills.id_candidate = ${idCandidate};".toString())
            }
        }
        catch(Exception e){
